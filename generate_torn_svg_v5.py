...
# Seed for reproducibility if needed, but random is fine
random.seed(42)
...
while x <= width:
    ...
    # The white curl is very pronounced on some edges
    jitter_curl = random.uniform(3, 10)
...
print("Generated torn-edge.svg v5")
